            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Yeni hesab parolu yaradın</h4>

                        <form id="formAuthentication" class="mb-3"
                            action="<?php echo base_url('reset_password/update'); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit">Parolu dəyiş</button>
                            </div>
